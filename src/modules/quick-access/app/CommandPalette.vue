...
} from '@modules/quick-access/app/lib/commandPaletteHistory'
import {
  mergePaletteHits,
  getPaletteKindOrder
} from '@modules/quick-access/app/lib/commandPaletteSearch'
import { getQuickAccessKindMeta } from '@shared/module-bridge/quickAccessRendererBridge'
