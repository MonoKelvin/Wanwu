...
export const DIAGRAM_SHAPE_CATEGORIES: DiagramShapeCategory[] = [
  {
    ...
    label: '基础',
    items: [
      { id: 'dg-rect', label: '矩形', lfType: 'dg-rect', defaultText: '', preview: { kind: 'rect', w: 1.6, h: 0.75 } },
      { id: 'dg-round-rect', label: '圆角矩形', lfType: 'dg-round-rect', defaultText: '', preview: { kind: 'rect', w: 1.6, h: 0.75, r: 0.15 } },
      { id: 'dg-square', label: '正方形', lfType: 'dg-square', defaultText: '', preview: { kind: 'rect', w: 1, h: 1, r: 0.06 } },
      { id: 'dg-circle', label: '圆形', lfType: 'dg-circle', defaultText: '', preview: { kind: 'circle', r: 0.5 } },
      { id: 'dg-ellipse', label: '椭圆', lfType: 'dg-ellipse', defaultText: '', preview: { kind: 'ellipse', rx: 0.85, ry: 0.5 } },
      { id: 'dg-decision', label: '菱形', lfType: 'dg-decision', defaultText: '', preview: { kind: 'diamond', rx: 0.85, ry: 0.6 } },
      { id: 'dg-triangle-up', label: '三角形', lfType: 'dg-triangle-up', defaultText: '', preview: { kind: 'polygon', points: [[0, -0.85], [0.95, 0.75], [-0.95, 0.75]] } },
      { id: 'dg-triangle-down', label: '倒三角', lfType: 'dg-triangle-down', defaultText: '', preview: { kind: 'polygon', points: [[0, 0.85], [0.95, -0.75], [-0.95, -0.75]] } }
    ]
  },
  {
    id: 'flowchart',
    label: '流程图',
    items: [
      { id: 'dg-terminator', label: '开始/结束', lfType: 'dg-terminator', defaultText: '', preview: { kind: 'rect', w: 1.7, h: 0.65, r: 0.35 } },
      { id: 'dg-process', label: '过程', lfType: 'dg-process', defaultText: '', preview: { kind: 'rect', w: 1.7, h: 0.7, r: 0.06 } },
      { id: 'dg-decision-flow', label: '判定', lfType: 'dg-decision', defaultText: '', preview: { kind: 'diamond', rx: 0.9, ry: 0.65 } },
      { id: 'dg-document', label: '文档', lfType: 'dg-document', defaultText: '', preview: { kind: 'path', d: 'M4 5 H16 L18 7 V19 H4 Z' } },
      { id: 'dg-multi-document', label: '多文档', lfType: 'dg-multi-document', defaultText: '', preview: { kind: 'path', d: 'M6 7 H16 L18 9 V19 H6 Z M4 5 H14 L16 7 V17 H4 Z' } },
      { id: 'dg-data', label: '数据', lfType: 'dg-data', defaultText: '', preview: { kind: 'polygon', points: [[-1, -0.7], [0.75, -0.7], [1, 0.7], [-0.8, 0.7]] } },
      {
        id: 'dg-subprocess',
        label: '子流程',
      ...
      { id: 'dg-preparation', label: '准备', lfType: 'dg-preparation', defaultText: '', preview: { kind: 'polygon', points: [[0, -0.85], [0.95, -0.42], [0.95, 0.42], [0, 0.85], [-0.95, 0.42], [-0.95, -0.42]] } },
      { id: 'dg-manual-input', label: '人工输入', lfType: 'dg-manual-input', defaultText: '', preview: { kind: 'polygon', points: [[-0.9, -0.7], [0.9, -0.7], [0.7, 0.7], [-0.7, 0.7]] } },
      { id: 'dg-delay', label: '延迟', lfType: 'dg-delay', defaultText: '', preview: { kind: 'path', d: 'M4 6 H11 A5 5 0 0 1 11 16 H4 Z' } },
      { id: 'dg-display', label: '显示', lfType: 'dg-display', defaultText: '', preview: { kind: 'polygon', points: [[-1, -0.7], [1, -0.7], [1, 0.2], [0, 0.85], [-1, 0.2]] } },
      { id: 'dg-stored-data', label: '存储', lfType: 'dg-stored-data', defaultText: '', preview: { kind: 'path', d: 'M5 8 A7 2 0 0 1 19 8 V16 A7 2 0 0 1 5 16 Z M5 8 A7 2 0 0 0 19 8' } },
      { id: 'dg-or', label: '或者', lfType: 'dg-or', defaultText: '', preview: { kind: 'polygon', points: [[0, -0.85], [0.75, -0.25], [0.75, 0.25], [0, 0.85], [-0.75, 0.25], [-0.75, -0.25]] } },
      { id: 'dg-off-page', label: '离页连接', lfType: 'dg-off-page', defaultText: '', preview: { kind: 'polygon', points: [[-0.8, -0.7], [0.8, -0.7], [0.8, 0.1], [0.35, 0.85], [-0.8, 0.85]] } },
      { id: 'dg-merge', label: '合并', lfType: 'dg-merge', defaultText: '', preview: { kind: 'polygon', points: [[0, 0.85], [0.95, -0.75], [-0.95, -0.75]] } },
