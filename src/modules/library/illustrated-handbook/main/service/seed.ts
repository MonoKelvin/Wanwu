...
import type { LibraryDatabaseHost } from '../libraryDatabaseHost'
import {
...
import { getWanwuPathLayout, wanwuDbMarkerFile } from '../../../../../../electron/services/data/paths'
import {
...
function tryFastSkipImportNew(dbService: LibraryDatabaseHost): ImportLibraryResult | null {
  const fp = computeSeedFingerprint()
...
export function collectExistingItemIds(dbService: LibraryDatabaseHost): Map<string, Set<string>> {
...
export function syncLibraryMediaFromCatalog(dbService: LibraryDatabaseHost): ImportLibraryResult {
...
export function runStartupLibrarySeed(dbService: LibraryDatabaseHost): void {
...
function syncLibraryMediaFromCatalogIfNeeded(dbService: LibraryDatabaseHost): void {
  const catalog = loadLibraryCatalog()
