import type { ShareExportFormat } from '@modules/library/illustrated-handbook/item/utils/exportDetailHtml'
import {
  captureBackgroundColor,
  shareCaptureFixCss,
  syncThemeVarsToClone
} from '@modules/library/illustrated-handbook/item/utils/shareExportTheme'
