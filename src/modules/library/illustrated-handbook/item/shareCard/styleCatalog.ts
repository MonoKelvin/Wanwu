...
export const SHARE_CARD_COLOR_OPTIONS: ShareCardColorOption[] = [
  { id: 'auto', label: '¸úËæ·âÃæ', swatch: 'linear-gradient(135deg, #8a8a94 0%, #ececee 50%, #5a5a62 100%)' },
  { id: 'white', label: '´¿°×', swatch: '#ffffff' },
  { id: 'black', label: '´¿ºÚ', swatch: '#121214' },
  { id: 'gold', label: 'Å¯½ð', swatch: '#f5e6c8' },
  { id: 'ice', label: 'ÀäÀ¶', swatch: '#d8ecff' },
  { id: 'cream', label: 'Ã×°×', swatch: '#faf6ef' },
  { id: 'rose', label: 'Èá·Û', swatch: '#ffd9e3' },
  { id: 'mint', label: '±¡ºÉ', swatch: '#d4f5e9' },
  { id: 'lavender', label: 'Þ¹ÒÂ²Ý', swatch: '#e8deff' },
  { id: 'coral', label: 'Éºº÷', swatch: '#ffb4a2' },
  { id: 'charcoal', label: 'Éî»Ò', swatch: '#3a3a42' },
  { id: 'sky', label: 'ÌìÇà', swatch: '#b8e4ff' }
]
