...
import type { ShareCardTemplateId } from '@modules/library/illustrated-handbook/item/shareCard/types'
import type {
  ShareCardColorId,
  ShareCardFilterId,
  ShareCardFontId,
  ShareCardSizeId,
  ShareCardStyle
} from '@modules/library/illustrated-handbook/item/shareCard/styleCatalog'
import {
...
} from '@modules/library/illustrated-handbook/item/utils/renderItemShareCard'
...
async function renderPreview() {
  ...
  try {
    ...
    if (seq !== renderSeq) return
    if (!previewUrl.value) error.value = '����Ԥ��ʧ��'
  } finally {
    ...
    >
      <div class="ww-share-card-dialog__preview-col">
        <div class="ww-share-card-dialog__preview">
          <div class="ww-share-card-dialog__preview-body">
            ...
            />
            <p v-else-if="!previewGenerating" class="ww-share-card-dialog__status">����Ԥ��</p>
          </div>
          <div
      ...
      >
        <div class="ww-share-card-dialog__settings-section">
          <span class="ww-share-card-dialog__settings-label">�˾�</span>
        ...
        <div class="ww-share-card-dialog__settings-section">
          <span class="ww-share-card-dialog__settings-label">�ֺ�</span>
          <div class="ww-share-card-dialog__chip-grid">
            <button
        ...
        <div class="ww-share-card-dialog__settings-section">
          <span class="ww-share-card-dialog__settings-label">��ɫ</span>
