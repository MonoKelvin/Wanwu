...
import ItemDetailHeroActions from '@modules/library/illustrated-handbook/item/ItemDetailHeroActions.vue'
import { WwMarkdownReader } from '@shared/markdown'
import FavoriteGroupPickerDialog from '@modules/library/illustrated-handbook/item/FavoriteGroupPickerDialog.vue'
import ItemShareCardDialog from '@modules/library/illustrated-handbook/item/ItemShareCardDialog.vue'
import ItemShareImageDialog from '@modules/library/illustrated-handbook/item/ItemShareImageDialog.vue'
import { buildItemCopyText } from '@modules/library/illustrated-handbook/item/utils/buildItemCopyText'
...
import UnsplashAttribution from '@modules/library/illustrated-handbook/item/UnsplashAttribution.vue'
