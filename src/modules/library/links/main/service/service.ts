...
import type { LinkBookmark, LinkFolder, LinksSyncResult } from '@modules/library/links/domain/types'
...
import { linksDbFile } from '../linksPaths'
import type { LinksProbeProgress, LinksProbeSummary } from '@modules/library/links/domain/types'
...
export class LinksService {
  ...
  constructor(private readonly basePath: string) {
    ...
    this.db = new Database(linksDbFile(layout))
    this.initSchema()
    this.migrateSchema()
