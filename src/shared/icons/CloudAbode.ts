...
/** 云斋模块图标（实心路径，跟随 currentColor） */
const CloudAbode: FunctionalComponent<LucideProps> = (props) => {
  const { size = 24, strokeWidth: _sw, absoluteStrokeWidth: _asw, fill: _fill, ...rest } = props
  return h(
    'svg',
    {
