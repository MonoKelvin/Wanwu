...
import type {
  ...
  WanwuDocumentPackageFactory
} from '../IWanwuDocumentPackage'
import type {
  PackageOpenOptions,
  PackageSaveOptions,
  PackageVerifyResult,
...
export class WanwuDocumentPackage implements IWanwuDocumentPackage {
...
export const wanwuDocumentPackageFactory: WanwuDocumentPackageFactory = WanwuDocumentPackage
