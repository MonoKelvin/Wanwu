...
游戏启动图（Splash / Key Visual）是标题界面或宣传主视觉，需在单帧传达世界观、主角与情绪，驱动下载与记忆点。

![游戏宣传图](https://upload.wikimedia.org/wikipedia/commons/9/9f/Video_game_cover_art.jpg)

![手游 UI 示意](https://upload.wikimedia.org/wikipedia/commons/2/2f/Mobile_game_ui.jpg)
...
常见于手游、主机开机与展会背板；与 LOGO、Slogan 组合。

## 艺术与历史背景

营销与玩法期待管理；季节活动常更换 splash。

## 影响与鉴赏

插画师与营销团队协作；A/B 测试优化转化率。
...
- [百度百科](https://baike.baidu.com/item/%E6%B8%B8%E6%88%8F)
- [维基：Key art](https://en.wikipedia.org/wiki/Key_art)
- [Steam 商店图规范](https://partner.steamgames.com)
