...
AMG GT 是奔驰前置 V8 跑车平台，Black Series 版追求极致赛道性能。 下文从起源、工程与文化三方面展开，方便快速建立完整印象。

从读者角度，把「标准书描述」与「真实饲养体验」对照着看，更容易判断自己是否适合该主题：时间投入、预算、空间与家庭成员（老人、幼儿、其他宠物）都会改变答案。以下内容在常识基础上稍作延展，便于形成 3–5 分钟可读完的完整印象。

## 背景与历史

2014 年取代 SLS；2023 年 AMG GT 63 与 SL 共享 4.0 L 平台。
...
4.0 L 双涡轮 V8，Black Series 约 730 hp；后驱与四驱版本并存。
...
- [AMG GT](https://www.mercedes-amg.com/)
- [维基百科](https://en.wikipedia.org/wiki/Mercedes-AMG_GT)
