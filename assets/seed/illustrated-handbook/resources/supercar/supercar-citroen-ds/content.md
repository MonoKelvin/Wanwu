...
雪铁龙 DS（1955–1975）以液压气动悬挂、前卫造型被称为「来自外星的汽车」，影响工业设计史。 下文从起源、工程与文化三方面展开，方便快速建立完整印象。

![雪铁龙 DS](https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Paris_-_Citroen_DS_19_1956_-_1500px.jpg/640px-Paris_-_Citroen_DS_19_1956_-_1500px.jpg)
...
1955 年巴黎车展 12 分钟内收到 743 份订单；1969 年 DS 21 配备博世喷射。总统座驾与电影常客。
...
液压高度可调悬挂（Hydractive）、碟刹、轻量化车身；风阻系数当时领先。
...
法国设计骄傲；查尔斯·戴高乐遇刺时 DS 轮胎中弹仍可行驶成为传奇。
...
- DS 在法语发音类似「女神」Déesse。
- SM 版搭载 Maserati V6 成 GT 旗舰。
- 2005 年评选为最具标志性汽车之一。
...
- [Citroën DS](https://www.citroen.com/)
- [维基百科](https://en.wikipedia.org/wiki/Citro%C3%ABn_DS)
