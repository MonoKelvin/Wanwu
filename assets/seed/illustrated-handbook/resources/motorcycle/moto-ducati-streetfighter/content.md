...
Streetfighter V4 将 Panigale V4 动力植入裸车平台，被誉为「街头导弹」，扭矩与电控极其激进。

从读者角度，把「标准书描述」与「真实饲养体验」对照着看，更容易判断自己是否适合该主题：时间投入、预算、空间与家庭成员（老人、幼儿、其他宠物）都会改变答案。以下内容在常识基础上稍作延展，便于形成 3–5 分钟可读完的完整印象。

## 背景与历史

Streetfighter 传统始于 2009 年 1098 S 改装概念；V4 版继承 MotoGP 技术，2020 年首发即刷新同级马力记录。
...
1103 cc V4 约 208 hp，整流罩拆除后仍保留大油箱侧翼；全套 Panigale 级 IMU 电控与 Öhlins 避震。
...
- 名称源于赛道日拆掉整流罩的「Streetfighter」改装。
- V4 S 版标配 Öhlins 智能避震。
- SP 版采用更多碳纤维减轻重量。
...
- [Ducati Streetfighter](https://www.ducati.com/)
- [维基百科](https://en.wikipedia.org/wiki/Ducati_Streetfighter_V4)
