...
比摩塔 Tesi 以轮毂转向（Hub-center steering）闻名，是意大利小众工程实验的旗舰。
...
1980 年代 Piero Bimota 与设计师合作探索替代传统前叉；Tesi 3D、H2 等版本持续迭代，限量手工生产。
...
轮毂转向分离制动与转向力，减少俯冲转移；常搭载 Ducati 或 Kawasaki 发动机。碳纤维与 CNC 加工件为主。
...
- Bimota 名字来自创始人 Bimota 缩写 B.I.M.O.T.A。
- Tesi 意为「论文」，喻指技术实验。
- 部分版本采用 H2 机械增压发动机。
...
- [维基百科：Tesi](https://en.wikipedia.org/wiki/Bimota_Tesi)
