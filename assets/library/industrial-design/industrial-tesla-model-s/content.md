...
Tesla Model S 以极简内饰、大屏交互与长续航重新定义豪华电动轿车设计语言。

![Tesla Model S](https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Tesla_Model_S_2021.jpg/640px-Tesla_Model_S_2021.jpg)
...
2012 年交付；2015 年 Ludicrous 模式刷新性能认知；Plaid 三电机 1020 hp。Yoke 方向盘争议后回归圆形。
...
平底滑板电池包；OTA 持续更新功能。风阻系数 0.208（部分版本）领先轿车。
...
- 早期提供免费 Supercharger。
- 隐藏门把手成为电动车流行元素。
- Bioweapon Defense Mode 空气过滤营销名。
...
- [维基百科](https://en.wikipedia.org/wiki/Tesla_Model_S)
