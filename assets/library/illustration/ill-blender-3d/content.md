...
Blender 是开源 3D 套件，可用于 NPR 渲染、三渲二与插画级静帧，结合 Grease Pencil 实现 2D/3D 混合风格。

![Blender 标志](https://upload.wikimedia.org/wikipedia/commons/0/0c/Blender_logo_no_text.svg)

![3D 视口](https://upload.wikimedia.org/wikipedia/commons/6/6f/Blender_screenshot.png)
...
2002 年起开源；Cycles/Eevee 渲染器；几何节点提升程序化。

## 艺术与历史背景

《蜘蛛侠：平行宇宙》等推动非写实 3D 美学。

## 影响与鉴赏

降低 3D 插画门槛；大逃杀电影级短片展示社区力。

## 冷知识

- 三渲二需控制描边与色阶。
- Blender Studio 免费教程官方出品。
- 版本号跳至 4.x 几何节点成熟。
...
- [百度百科](https://baike.baidu.com/item/Blender)
- [维基](https://zh.wikipedia.org/wiki/Blender)
