...
M4 CSL 致敬 3.0 CSL「蝙蝠车」，限量 1000 辆，极致减重与圈速导向。 下文从起源、工程与文化三方面展开，方便快速建立完整印象。

从读者角度，把「标准书描述」与「真实饲养体验」对照着看，更容易判断自己是否适合该主题：时间投入、预算、空间与家庭成员（老人、幼儿、其他宠物）都会改变答案。以下内容在常识基础上稍作延展，便于形成 3–5 分钟可读完的完整印象。

## 背景与历史

2022 年发布；CSL 意为 Coupé Sport Leicht。纽北调校成为营销重点。
...
3.0 L 直六 双涡轮约 550 hp，后驱；碳纤维车顶、桶椅与钛合金排气减重。
...
- [M4 CSL](https://www.bmw.com/)
- [维基百科](https://en.wikipedia.org/wiki/BMW_M4#M4_CSL_(2022%E2%80%93present))
