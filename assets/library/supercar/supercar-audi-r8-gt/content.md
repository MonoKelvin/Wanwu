...
5.2 L V10 约 620 hp，减重 20+ kg，固定尾翼与碳纤维套件；7 速双离合。
...
- GT 传统在奥迪 RS 系列意味 Grand Touring 运动化。
- 提供 RWD 更纯粹驾驶。
- 配色包含迷彩绿限量。
