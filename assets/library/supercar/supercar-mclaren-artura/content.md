...
Artura 是迈凯伦新一代混动超跑，搭载全新 MCLA 平台与 V6 双涡轮，标志品牌动力架构转型。 下文从起源、工程与文化三方面展开，方便快速建立完整印象。

从读者角度，把「标准书描述」与「真实饲养体验」对照着看，更容易判断自己是否适合该主题：时间投入、预算、空间与家庭成员（老人、幼儿、其他宠物）都会改变答案。以下内容在常识基础上稍作延展，便于形成 3–5 分钟可读完的完整印象。

## 背景与历史

2021 年发布，取代 570S 系列；首次在量产车使用 V6 与轴向磁通电机。
...
3.0 L V6 双涡轮 + 电机约 680 hp，8 速双离合无倒挡（靠电机倒车）；高压电池 7.4 kWh。
...
- [Artura](https://www.mclaren.com/)
- [维基百科](https://en.wikipedia.org/wiki/McLaren_Artura)
