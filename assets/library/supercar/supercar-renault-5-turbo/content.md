...
Renault 5 Turbo 是中置后驱热掀背传奇，为 Group B 拉力 homologation 而生，宽体与涡轮动力极具个性。 下文从起源、工程与文化三方面展开，方便快速建立完整印象。

从读者角度，把「标准书描述」与「真实饲养体验」对照着看，更容易判断自己是否适合该主题：时间投入、预算、空间与家庭成员（老人、幼儿、其他宠物）都会改变答案。以下内容在常识基础上稍作延展，便于形成 3–5 分钟可读完的完整印象。

## 背景与历史

1980 年首发；Maxi Turbo 赢得多项拉力赛。2020 年代电动 R5 E-Tech 致敬经典造型。
...
1.4 L 涡轮中置约 160 hp（后期 350hp 赛车版）；后轮驱动，宽体轮拱与巨大进气口。
...
- [Renault 5 Turbo](https://www.renault.com/)
- [维基百科](https://en.wikipedia.org/wiki/Renault_5_Turbo)
