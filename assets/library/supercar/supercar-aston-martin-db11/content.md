...
DB11 重启阿斯顿 GT 现代语言，V12 与双涡轮 V8 并存，英伦优雅与手工内饰著称。 下文从起源、工程与文化三方面展开，方便快速建立完整印象。

从读者角度，把「标准书描述」与「真实饲养体验」对照着看，更容易判断自己是否适合该主题：时间投入、预算、空间与家庭成员（老人、幼儿、其他宠物）都会改变答案。以下内容在常识基础上稍作延展，便于形成 3–5 分钟可读完的完整印象。

## 背景与历史

2016 年取代 DB9；2023 年后由 DB12 接棒但 DB11 已成收藏经典。
...
5.2 L 双涡轮 V12 约 630 hp 或 AMG 4.0 V8；铝制粘合单体壳与自适应阻尼。
...
- [维基百科](https://en.wikipedia.org/wiki/Aston_Martin_DB11)
