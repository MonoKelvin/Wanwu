...
Aventador 以 V12 自然吸气与剪刀门延续兰博基尼狂野基因，是 2010 年代超跑视觉图腾。 下文从起源、工程与文化三方面展开，方便快速建立完整印象。

![兰博基尼 Aventador](https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Lamborghini_Aventador_S.jpg/640px-Lamborghini_Aventador_S.jpg)
...
2011 年取代 Murciélago；SVJ 版曾刷新纽北纪录。2022 年停产为 Revuelto 让路。
...
6.5 L V12 约 770 hp，ISR 单离合序列变速；碳纤维单体壳与推杆悬挂。
...
- Aventador 名称来自西班牙斗牛名牛。
- SVJ 代表 Super Veloce Jota。
- Ultimae 为最后限量系列。
...
- [维基百科](https://en.wikipedia.org/wiki/Lamborghini_Aventador)
