...
Emira 是路特斯最后燃油跑车，中置布局承袭 Elise/Exige 轻量哲学并引入 AMG 动力。 下文从起源、工程与文化三方面展开，方便快速建立完整印象。

从读者角度，把「标准书描述」与「真实饲养体验」对照着看，更容易判断自己是否适合该主题：时间投入、预算、空间与家庭成员（老人、幼儿、其他宠物）都会改变答案。以下内容在常识基础上稍作延展，便于形成 3–5 分钟可读完的完整印象。

## 背景与历史

2021 年发布，取代 Elise、Exige、Evora；2027 年后全面电动化规划。
...
2.0 L 涡轮四缸或 3.5 L V6 机械增压；粘合铝底盘与液压助力转向保留纯粹路感。
...
「路特斯最后内燃」引发收藏关注；设计由 Russell Carr 操刀。
...
- [Lotus Emira](https://www.lotuscars.com/)
- [维基百科](https://en.wikipedia.org/wiki/Lotus_Emira)
